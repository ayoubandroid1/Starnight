...
const cors_1 = __importDefault(require("cors")); // Import cors from its package
...
const my_hotels_1 = __importDefault(require("../dist/routes/my-hotels"));
...
app.use(express_1.default.static(path_1.default.join(__dirname, "../../website_project/hotel-app/dist")));
