...
import "../ManageHotelForm/ManageHotelForm.css"
import { Select, Option } from "@material-tailwind/react";
import { FormProvider, useForm } from 'react-hook-form';
import DetailsSection from './DetailsSection';
import TypeSection from './TypeSection';
import FacitilitiesSection from './FacitilitiesSection';
...
function ManageHotelForm({ onSave, isLoading , hotel }: Props) {
  ...
  const Submit = handleSubmit((formDataJson: HotelFormData) => {
  ...
  return (
    <FormProvider {...formMethods}>
      <div>
        <div className="bg absolute inset-0 -z-10 h-full w-full bg-white bg-[radial-gradient(#e0ae79_1px,transparent_1px)] [background-size:16px_16px]" >
        </div>
  ...
  <button disabled={isLoading} className="relative mt-4 rounded-lg border-2 border-blue-700 bg-blue-700 px-6 py-2 font-medium text-white transition hover:translate-y-1">
